        ...
        <div className="container relative z-10">
          <div className="text-center mb-12 flex flex-col items-center justify-center">
            <h2 className="font-headline text-3xl font-bold tracking-tight sm:text-4xl text-center">
              Explore Our Specialized Industry Solutions
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground md:text-lg text-center">
              Techvalio supports a wide range of industries with tailored compliance, validation, and technology services—delivering expertise for every sector.
            </p>
          </div>
